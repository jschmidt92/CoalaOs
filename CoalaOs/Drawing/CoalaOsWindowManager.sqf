...
fnCoala_drawBackgroundImage = {
	_backgroundControl = ["RscPicture", MISSION_ROOT + "CoalaOs\Images\background.jpg", GUI_LEFT, GUI_TOP, GUI_WIDTH, GUI_HEIGHT] call addCtrl;
};
...
fnCoala_AddDesktopIcon = {
	...
	_icon = ["RscPicture", MISSION_ROOT + _picture, _this select 0, _this select 1, 4, 3] call addCtrl;
...
//Draws the Desktop
fnCoala_DrawDesktop = {
	_explorer = [GUI_LEFT + 2, GUI_TOP + 2, "CoalaOs\Images\driveB.paa", "C:\", 1.1] call fnCoala_AddDesktopIcon;
	...
	_browser = [GUI_LEFT + 14, GUI_TOP + 2, "CoalaOs\Images\browser.paa", "    Portal", 0] call fnCoala_AddDesktopIcon;
	(_browser select 0) ctrlAddEventHandler ["MouseButtonDblClick", {
		_width = 62.5;
		_height = 27.5;
		_standartURL = "https://a3sog.org/portal";
		_newWindow = [-11.25, -4, _width, _height, "Portal - Home"] call fnCoala_DrawWindow;
		...
		[_newWindow select 0, _fdic, [21, 4, _width - 42, _height - 21]] call fnCoala_addControlToWindow;
		...
		[_newWindow select 0, _gms, [21, 11, _width - 42, _height - 21]] call fnCoala_addControlToWindow;
		...
		[_newWindow select 0, _fms, [21, 18, _width - 42, _height - 21]] call fnCoala_addControlToWindow;
